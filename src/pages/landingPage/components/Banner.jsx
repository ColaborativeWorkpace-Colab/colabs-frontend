...
const Banner = () => {
  return (
    <div className="block bg-white shadow-lg rounded-lg dark:bg-gray-800 dark:border-gray-700 p-2">
      ...
      <div className="px-4 py-8 grid grid-cols-2 md:grid-cols-4  gap-2 justify-between ">
        <div className="px-1 pointer shadow-md  max-w-sm p-5 bg-white hover:scale-105 transition-all  rounded-lg text-center">
          <img
