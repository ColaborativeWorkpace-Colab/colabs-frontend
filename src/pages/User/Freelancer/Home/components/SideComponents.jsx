...
export const RightSide = () => {
	...
	return (
		...
		<div className="right-side lg:block h-screen flex flex-col lg:w-[300px] bg-white shadow-sm rounded-lg shadow-gray-300">
			<h1 className='font-bold text-gray-800 pl-10 pt-6 shadow-sm'>Add to Your Feed </h1> 
		...
		{datas.map(data => (
		  ...
		  <img className='block mx-auto w-10  h-auto rounded-full cursor-pointer sm:mx-0 sm:shrink-0 pr-2' src={data.imgUrl} alt="Avatar" />
		  <div>
			  <h1 className='font-bold text-gray-800 pl-3 hover:underline cursor-pointer capitalize text-sm'>{data.name}</h1>
