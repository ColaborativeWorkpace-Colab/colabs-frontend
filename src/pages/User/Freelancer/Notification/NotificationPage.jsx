...
const NotificationPage = () => {
  ...
  return (
    <>
      ...
      {listNotification.map((v, k) => (
        <div class="py-8 px-8 w-1/2  mx-auto bg-white rounded-xl shadow-lg space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
          <img
