	...
	return (
		<div className="block bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-2">
			...
			<div className="px-4 py-8 grid grid-cols-2 md:grid-cols-4  gap-2 justify-between ">
				<div class="px-1 pointer max-w-sm p-5 bg-white hover:border hover:border-purple-200 rounded-lg hover:shadow text-center">
					<img
						class="mx-auto w-10 h-10 mb-2 text-gray-500 dark:text-gray-400"
						src={account}
					/>
